...
set CLASSPATH=%APP_HOME%\lib\PiSoundSample-all.jar

@rem Execute PiSoundSample
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PI_SOUND_SAMPLE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%PI_SOUND_SAMPLE_EXIT_CONSOLE%" exit 1
exit /b 1
